  ...
  <div class="container-fluid">
    ...
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Released Ticket Report</h4>
      </div>
   ...
   <div class="row">
     <div class="col-lg-12">
       <div class="card">
        <div class="card-body">
          <h4 class="card-title"><i class="icon-list"></i> &nbsp;Released Ticket List</h4>
        ...
        <div class="table-responsive m-t-40">
          <table id="tbl_ticket_list" class="table table-bordered table-striped " width="100%">
            <thead>
              <tr>
                <th>Date</th>
                <th>Incharge</th>
