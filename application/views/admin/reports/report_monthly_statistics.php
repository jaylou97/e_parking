            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive m-t-40">
                        <div><label id="elem2" style="margin: 10px 0px -10px 0px; font-weight: bolder;"><b> Period:</b> <?php echo $mm_data['date_first'];?> to <?php echo $mm_data['date_end'];?></label></div>
                        <div id="elem3">
                        ...
                        <tfoot class="">
                            ...
                            <tr>
                                     <td class="text-center  bordertop ctd">Monthly Grand Total :</td>
                            ...
                            <tr>
                                <td class="text-center bordertopbot2 ctd">Weekly Average:</td>
                                 <td class="text-center bordertopbot2 ctd"><?php echo $w_average['w4in']; ?></td>
                                    <td class="text-center bordertopbot2 ctd"><?php echo $w_average['w4out']; ?></td>
                                    <td class="text-right bordertopbot2 rtd"><?php echo $w_average['pw4']; ?></td>
                                    <td class="text-center bordertopbot2 ctd"><?php echo $w_average['w2in']; ?></td>
                                    <td class="text-center bordertopbot2 ctd"><?php echo $w_average['w2out']; ?></td>
                                    <td class="text-right bordertopbot2 rtd"><?php echo $w_average['pw2']; ?></td>
                                    <td class="text-right bordertopbot2 rtd"><?php echo $w_average['s_tot']; ?></td>
                            </tr>
                             <tr>
                                <td class="text-center borderbot ctd">Daily Average:</td>
                                 <td class="text-center borderbot ctd"><?php echo $d_average['w4in']; ?></td>
                                    <td class="text-center borderbot ctd"><?php echo $d_average['w4out']; ?></td>
                                    <td class="text-right borderbot rtd"><?php echo $d_average['pw4']; ?></td>
                                    <td class="text-center borderbot ctd"><?php echo $d_average['w2in']; ?></td>
                                    <td class="text-center borderbot ctd"><?php echo $d_average['w2out']; ?></td>
                                    <td class="text-right borderbot rtd"><?php echo $d_average['pw2']; ?></td>
                                    <td class="text-right borderbot rtd"><?php echo $d_average['s_tot']; ?></td>
                            </tr>
                        </tfoot>
                    </table>
                    </div>
                ...
                <div  class="table-responsive m-t-40" style="clear: both;">
                    ...
                    <table class="mytable borderall" id="tbl_2" width="100%">
                        <thead>
                            <tr>
                                <th class="borderbot ltd" colspan="8">Monthly Summary</th>
                            </tr>
                            <tr>
                                <th class="text-center borderbotri ctd">Weeks</th>
                        ...
                        <tbody>
                           <?php foreach ($average_data as $key => $value): ?>
                                <tr>
                                    <td class="text-center ctd">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo  $value['week_num']; ?>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td class="text-center  ctd"><?php echo $value['w4in'] ?></td>
                                    <td class="text-center ctd"><?php echo $value['w4out'] ?></td>
