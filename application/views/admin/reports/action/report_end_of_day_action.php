   ...
   $('#printx').on('click',function(){
    ...
    PrintElem('#elem');
         ...
         function PrintElem(elem)
        {
            ...
            mywindow.document.write('.item1{grid-area: main; text-align:top;}.item2{grid-area: right; margin-left:10%; }.grdcon{display:grid; grid-template-areas:"main right";grid-gap: 0px;} ');
            ...
            mywindow.document.write('<div style="margin-top:2%;font-size:13px;">'+dev3+'</div>');
            mywindow.document.write('<div style="margin-top:-1%;font-size:13px; float:right;">'+dev5+'</div>');
            mywindow.document.write('<div style="margin-top:5%;font-size:13px;" class="grdcon">'+dev4+'</div>');
