    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12" >
                <div class="pull-left col-md-7" hidden="">
                    <h5 id="elem2" style="font-weight: bolder;"><b>Paid Blacklisted</b></h5>
                    
                </div>
            </div>
            <div  class="col-md-12">
                    <label id="elem3" style=" font-weight: bolder;"><label style="font-weight: bold; font-size: 18px;">Unblock Report List</label><br><b>For the Date: </b> <u><span id="dtstart2"></span> &nbsp;<b>to</b>&nbsp; <span id="dtend2"> </span></u></label>
            <div class="table-responsive" style="clear: both;">
            <table id="tbl_unblock_list" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th class="text-center"><b>No.</b></th>
                    <th class="text-center"><b>Incharge</b></th>
                    ...
                    <th class="text-center"><b>Date Paid</b></th>
                </tr>
                </thead>
            </table>
            </div>
        ...
        <div class="col-md-12" style="margin-top: 3%;">
            ...
            <div class="text-right">
                <button id="generate_textfile_btn" class="btn btn-success" onclick="generate_unblock_textfile_js()" disabled><i class=""></i>📄 Generate Text File </button>
