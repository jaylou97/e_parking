        ...
        <div class="row">
            <div class="col-md-12" >
                <div class="pull-left col-md-7" hidden="">
                    <h5 id="elem2" style="font-weight: bolder;"><b>Parking Attendant Login/Logout History</b></h5>
                    
                </div>
            </div>
            <div  class="col-md-12">
                    <label id="elem3" style=" font-weight: bolder;"><label style="font-weight: bold; font-size: 18px;">Login/Logout List</label><br><b>For the Date: </b> <u><span id="dtstart2"></span> &nbsp;<b>to</b>&nbsp; <span id="dtend2"> </span></u></label>
            <div class="table-responsive" style="clear: both;">
            <table id="tbl_loginlogout_list" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th class="text-center"><b>No.</b></th>
                    <th class="text-center"><b>Parking Attendant</b></th>
                    <th class="text-center"><b>Date/Time In</b></th>
                    <th class="text-center"><b>Date/Time Out</b></th>
